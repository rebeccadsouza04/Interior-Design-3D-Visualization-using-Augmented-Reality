...
public class MainActivity extends AppCompatActivity {
    ...
    private void addModelToScene(Anchor anchor, ModelRenderable modelRenderable) {
        ...
        btnChange.setOnClickListener(view -> changeAnchorNode(node,modelRenderable));
    ...
    public  void changeAnchorNode(TransformableNode node, ModelRenderable modelRenderable){

        final int[] mDefaultColor = {ContextCompat.getColor(MainActivity.this, R.color.design_default_color_primary)};
        AmbilWarnaDialog colorPicker = new AmbilWarnaDialog(this, mDefaultColor[0], new AmbilWarnaDialog.OnAmbilWarnaListener() {
            @Override
